...
class DataModule:
    ...
    def prepare_data(self):
        ...
        dataset_factory = lambda t: QM9(root=self.data_args.dataset_root, dataset_arg=self.data_args.dataset_arg, transform=t)
...
class FradFinetuner:
    '''Class to handle the finetuning of the Frad model.'''
    ...
    def _setup_logging(self):
        ...
        file_handler = logging.FileHandler(
            os.path.join(self.training_args.log_dir, "finetune.log")
        )
